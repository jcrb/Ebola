...
a <- cbind(cas, cas.g, cas.sl, cas.lb, cas.ng, cas.sg, cas.us, cas.sp)
b <- cbind(dcd, dcd.g, dcd.sl, dcd.lb, dcd.ng, dcd.sg, dcd.us, dcd.sp)
t <- rbind(a,b)
colnames(t) <- c("Total", "Guinée", "Sierra Leone", "Libéria", "Nigéria","Senegal", "USA", "Esgagne")
